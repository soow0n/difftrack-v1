...
from dust3r.croco.models.croco import CroCoNet  # noqa
import torch.nn.functional as F
# from dust3r.croco.models.croco.mod import FeatureL2Norm, unnormalise_and_convert_mapping_to_flow
...
class AsymmetricCroCo3DStereo (
    ...
    def forward(self, view1, view2, output_mode='enc_feat'):
        ...
        feat1, feat2, pos1, pos2 = self._encode_image_pairs(img1, img2, shape1, shape2) # feat1: b 1024 1024

        # combine all ref images into object-centric representation
        dec_feats, tgt_camap, src_camap = self._decoder(feat1, pos1, feat2, pos2)  # b 12 1024 1024

        '''
            dec_feats: [ dec_feat[0], . . . dec_feat[12]]
            where dec_feat[0] = (dec_feat1, dec_feat2)
        '''
        ...
        self.count+=1
        if self.count % 100 == 0:
            vis_attn_map(tgt_camap, img2, img1, self.count, save_path='./vis/camap/spair/REVERSE_eval512_dust3r512_recip_softargmax')
