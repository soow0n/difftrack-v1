...
class CogVideoXImageToVideoTrackPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    r"""
    ...
    def prepare_latents(
        ...
        if video is not None and frame_as_latent:
    ...
    def __call__(
        ...
        text_seq_len = prompt_embeds.size(1)
