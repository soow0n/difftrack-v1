...
def main(args):
    ...
    dataset = TAPVid(args, visualize=False)
    ...
    video_ori = None
    for j, (video, gt_trajectory, visibility, query_points_i) in enumerate(dataloader): 
        if args.chunk_frame_num == 3 and j < 22:
            continue
